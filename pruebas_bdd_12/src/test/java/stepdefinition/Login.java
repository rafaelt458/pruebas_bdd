...
public class Login {
    ...
    private static Map<String, JsonLocator> homepageLocators;
    ...
    public void escribeElNombreDeUsuario(String username) throws Exception {
        JsonLocator jsonLocator = JsonLocatorManager.getLocator(homepageLocators, usernameFieldKey);
    ...
    public void escribeLaClave(String password) throws Exception {
        JsonLocator jsonLocator = JsonLocatorManager.getLocator(homepageLocators, passwordFieldKey);
        elementInteraction.sendKeys(jsonLocator, password);
    }

    @When("pulsa el boton Login")
    public void pulsaElBotonLogin() throws Exception {
        JsonLocator jsonLocator = JsonLocatorManager.getLocator(homepageLocators, loginButtonKey);
    ...
    public void elSistemaMuestraElErrorDeCredencialesIncorrectas() throws Exception {
        JsonLocator jsonLocator = JsonLocatorManager.getLocator(homepageLocators, errorMessageKey);

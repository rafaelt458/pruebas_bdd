...
public class MainPage {
    ...
    private final String orderDropdownKey = "orderDropdown";
    private final String firstElementKey = "firstElement";
    ...
    public void orderProductoByVisibleText(String text) throws Exception {
        JsonLocator jsonLocator = JsonLocatorManager.getLocator(this.mainpageLocators, this.orderDropdownKey);
        this.elementInteraction.selectByVisibleText(jsonLocator, text);
    }

    public String getFirstElementName() throws Exception {
        JsonLocator jsonLocator = JsonLocatorManager.getLocator(this.mainpageLocators, this.firstElementKey);
        return this.elementInteraction.getText(jsonLocator);
    }
}